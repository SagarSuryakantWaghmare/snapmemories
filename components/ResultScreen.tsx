  ...
  return (
    <div className="w-full h-full min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100 dark:from-gray-900 dark:via-gray-950 dark:to-black flex flex-col overflow-hidden">
      ...
      <main className="flex-1 flex flex-col items-center justify-start sm:justify-center gap-4 p-4 pt-14 sm:pt-16 pb-28 sm:pb-32 overflow-auto">
        ...
        {showPrinting && (
          <div className="flex flex-col items-center gap-3 rounded-3xl border border-black/10 dark:border-white/10 bg-white dark:bg-gray-800 px-6 py-5 shadow-lg animate-fade-in">
        ...
        {showFinalKiosk && (
          <>
            ...
            {/* Strip preview */}
            <div
              className="rounded-2xl p-3 shadow-lg dark:shadow-[0_20px_40px_rgba(0,0,0,0.3)] hover:shadow-button-hover dark:hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)] transition-all duration-300 animate-scale-in"
              style={{
            ...
            {!hasAnyPhoto && (
              <p className="text-xs text-gray-700 dark:text-gray-300 text-center px-4 animate-fade-in">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50 px-4 pt-3 pb-4 safe-bottom bg-gradient-to-t from-white dark:from-gray-900 via-white/95 dark:via-gray-900/95 to-transparent backdrop-blur-sm border-t border-black/5 dark:border-white/10 shadow-xl dark:shadow-[0_20px_40px_rgba(0,0,0,0.3)]">
        <div className="mx-auto flex max-w-md gap-2">
          <button
            ...
            id="retake-btn"
            onClick={onRetake}
            className="flex-1 px-4 py-3 sm:py-3.5 text-sm font-bold bg-white dark:bg-gray-800 text-gray-800 dark:text-white border border-gray-300 dark:border-gray-700 rounded-full hover:shadow-button-hover dark:hover:shadow-[0_10px_25px_rgba(0,0,0,0.3)] active:scale-[0.98] shadow dark:shadow-lg transition-all duration-200 min-h-11 group"
          ...
          <button
            ...
            className="flex-1 px-4 py-3 sm:py-3.5 text-sm font-bold bg-gradient-to-r from-black to-gray-800 dark:from-white dark:to-gray-200 text-white dark:text-black rounded-full hover:shadow-button-hover dark:hover:shadow-[0_10px_25px_rgba(0,0,0,0.3)] active:scale-[0.98] shadow dark:shadow-lg transition-all duration-200 min-h-11 inline-flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:shadow-none group"
            aria-label={
              isDownloading
                ? 'Downloading…'
                : hasAnyPhoto
