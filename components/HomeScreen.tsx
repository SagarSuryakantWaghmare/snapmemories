  ...
  return (
    <main className="w-full h-full min-h-screen bg-gradient-to-br from-white via-gray-50 to-gray-100 dark:from-gray-950 dark:via-gray-900 dark:to-gray-900 flex flex-col items-center justify-center overflow-hidden p-4 relative">
      <section className="w-full max-w-md rounded-3xl border border-black/15 dark:border-white/15 bg-white/95 dark:bg-gray-800/95 backdrop-blur p-5 sm:p-6 text-center shadow-[0_20px_40px_rgba(0,0,0,0.08)] dark:shadow-[0_20px_40px_rgba(0,0,0,0.3)] animate-fade-in-up">
        ...
        <div className="mb-6 flex flex-wrap justify-center gap-2.5 text-[11px] sm:text-xs text-gray-700 dark:text-gray-200">
        ...
        <button
          type="button"
          onClick={onEnter}
          className="w-full px-8 sm:px-10 py-3 sm:py-3.5 bg-gradient-to-r from-pink-600 to-pink-700 dark:from-pink-600 dark:to-pink-700 text-white text-sm sm:text-base font-bold rounded-full hover:shadow-button-hover dark:hover:shadow-glow active:scale-[0.98] shadow-xl inline-flex items-center justify-center gap-2 transition-all duration-200 min-h-12 group relative overflow-hidden"
        ...
        >
          ...
          <span className="absolute inset-0 bg-gradient-to-r from-pink-700 to-pink-800 opacity-0 group-hover:opacity-100 transition-opacity duration-200" />
        </button>
